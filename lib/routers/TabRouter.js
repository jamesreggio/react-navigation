...
var _getRouterForRouteName = require('./getRouterForRouteName');

var _getRouterForRouteName2 = _interopRequireDefault(_getRouterForRouteName);
...
exports.default = function (routeConfigs) {
  ...
  return {
    ...
    getPathAndParamsForState: function getPathAndParamsForState(state) {
      ...
      var router = (0, _getRouterForRouteName2.default)(routeConfigs, routeName);
      var path = subPath;
      ...
      if (router) {
        ...
        var child = router.getPathAndParamsForState(stateRoute);

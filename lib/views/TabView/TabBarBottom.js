...
var TabBarBottom = function (_React$PureComponent) {
  ...
  function TabBarBottom() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabBarBottom.__proto__ || Object.getPrototypeOf(TabBarBottom)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      isVisible: true
    }, _this._keyboardDidShowSub = undefined, _this._keyboardDidHideSub = undefined, _this._keyboardDidShow = function () {
      _this.setState({
        isVisible: false
      });
  ...
  _createClass(TabBarBottom, [{
    ...
    value: function componentWillMount() {
      this._keyboardDidShowSub = _reactNative.Keyboard.addListener('keyboardDidShow', this._keyboardDidShow);
      this._keyboardDidHideSub = _reactNative.Keyboard.addListener('keyboardDidHide', this._keyboardDidHide);
    }
  }, {
    ...
    value: function render() {
      ...
      return this.state.isVisible ? React.createElement(

...
var isTablet = _reactNative.Dimensions.get('window').height / _reactNative.Dimensions.get('window').width < 1.6;
...
var TabBarBottom = function (_React$PureComponent) {
  ...
  _createClass(TabBarBottom, [{
    ...
    value: function render() {
      ...
      var isHeightConstrained = layout.height === 0 ? !isTablet : layout.height < 500;
      var tabBarStyle = [styles.tabBar, this._shouldUseHorizontalTabs() && isHeightConstrained ? styles.tabBarCompact : styles.tabBarRegular, style];
